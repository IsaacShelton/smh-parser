...
test('simple object', () => {
    expect((0, index_1.smh)('name: Isaac Shelton\nage: 150\nstatus: online')).toEqual({
        "name": "Isaac Shelton",
        "age": "150",
        "status": "online"
    });
...
\t- Item 1
\t- Item 2
    `)).toEqual(new index_1.Failure(index_1.ErrorCode.TabNotAllowed));
});
test('reject unterminated string', () => {
    expect((0, index_1.smh)(`"`)).toEqual(new index_1.Failure(index_1.ErrorCode.Unterminated));
});
test('reject unterminated string over multiple lines', () => {
    expect((0, index_1.smh)(`
    "

    `)).toEqual(new index_1.Failure(index_1.ErrorCode.Unterminated));
});
...
test('reject invalid markup - extra unquoted string', () => {
    ...
    `)).toEqual(new index_1.Failure(index_1.ErrorCode.UnableToParse));
});
